...
new g_sprite_shockwave[64] = "sprites/shockwave.spr"
new g_sprite_beam[64] = "sprites/beam.spr"
...
public plugin_precache()
{
    ...
    beamsprite = precache_model(g_sprite_beam);
    g_exploSpr = precache_model(g_sprite_shockwave)
