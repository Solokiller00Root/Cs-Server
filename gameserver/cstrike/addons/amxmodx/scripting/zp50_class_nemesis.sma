...
// Default models
new const models_nemesis_player[][] = { "models/zombie_plague/alien_44.mdl" }
new const models_nemesis_claw[][] = { "models/zombie_plague/alienclaws.mdl" }
...
public zp_fw_core_infect_post(id, attacker)
{
	...
	// Nemesis glow
	if (get_pcvar_num(cvar_nemesis_glow))
		set_user_rendering(id, kRenderFxGlowShell, 255, 0, 0, kRenderTransColor, 30);
